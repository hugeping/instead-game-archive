...
-- телефон - связь с человеком по номеру

-- поиск? - предмет -> номер в картотеке -->
-- в подвале, компьютер -- с картотекой.

-- найти нужную книгу, как?
...
с неожиданно высоким ускорением, начинает свой спуск.]]
	...
	окна.^^Ты можешь выйти на смотровую площадку.]];
	obj = {
		Careful {
			-"окна";
